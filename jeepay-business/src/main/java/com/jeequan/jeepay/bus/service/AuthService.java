package com.jeequan.jeepay.bus.service;
...
import com.jeequan.jeepay.bus.config.SystemYmlConfig;
    ...
    public String auth(String username, String password) {
        ...
        if (mchInfo != null) {
            ...
            if (mchInfo.getState() == CS.NO) {
                throw new BizException("当前商家状态不可用！");
            }
            if (mchInfo.getMchNoPid() == null) {
                throw new BizException("非商家账户！");
            }
        }
        // 放置权限集合
