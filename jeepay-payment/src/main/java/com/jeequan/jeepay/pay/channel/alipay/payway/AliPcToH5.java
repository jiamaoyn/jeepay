...
import com.jeequan.jeepay.pay.rqrs.payorder.payway.AliPcToH5OrderRQ;
...
public class AliPcToH5 extends AlipayPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ rq, PayOrder payOrder, MchAppConfigContext mchAppConfigContext) {
        ...
        AliPcToH5OrderRQ bizRQ = (AliPcToH5OrderRQ) rq;
        ...
        // 构造函数响应数据
        AliPcToH5OrderRS res = ApiResBuilder.buildSuccess(AliPcToH5OrderRS.class);
