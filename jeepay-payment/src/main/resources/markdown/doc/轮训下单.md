...
请求URL：https://联系客服获取/api/pay/unifiedOrderPolling
...
使用支付模板 | payHtmlModel | 否  | int | 1                                | 显示系统的支付html画面。 0-不使用[默认], 1-使用。
商品标题 | subject | 是  | String(64)  | 商品标题测试                           | 商品标题  
商品描述 | body | 是  | String(256) | 商品描述测试                           | 商品描述  
异步通知地址 | notifyUrl | 否  | String(128) | https://xxxxx/notify.htm         | 支付结果异步回调URL,只有传了该值才会发起回调 
...
支付数据 | payData | 否 | String | http://xxxxx/pay         | 发起支付用到的支付参数，如果微信公众号支付等 
...
请求URL：https://联系客服获取/api/pay/queryPolling
