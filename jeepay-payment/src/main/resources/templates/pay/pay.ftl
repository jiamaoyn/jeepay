...
<head>
    ...
    <!-- 依 赖 样 式-->
    <link rel="stylesheet" href="https://static.aod.icu/component/pear/css/pear.css" type="text/css"/>
    <link href="https://static.aod.icu/index/pay/console/qrcode.css" rel="stylesheet" />
    <script src="https://static.aod.icu/index/js/jquery-3.2.1.min.js"></script>
    <link rel="stylesheet" href="https://static.aod.icu/index/user/assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="https://static.aod.icu/index/user/assets/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="https://static.aod.icu/index/user/assets/css/demo.css" />
    <link rel="stylesheet" href="https://static.aod.icu/index/user/assets/vendor/libs/sweetalert2/sweetalert2.css" />
    <style>
        body {
            background: #f2f2f4;
        }
...
<div id="main">
    <div class="left">
        <div class="make">
            <p><img src="https://static.aod.icu/index/pay/console/images/alipay.jpg" alt="" style="height:30px;"></p>
            ...
            <center><p class="qrcode" id="qrcode" ><img class="kalecloud" id="qrcode_load" src="https://static.aod.icu/index/images/status/loading.gif" style="display: block;"></p></center>
            <center>
    ...
    <div class="right">
        <img src="https://static.aod.icu/index/pay/console/images/alipay-sys.png" />
    </div>
</div>
<script src="https://static.aod.icu/component/layer/layer.js"></script>
<script src="https://static.aod.icu/index/user/assets/vendor/libs/sweetalert2/sweetalert2.js"></script>
<script type="text/javascript" src="https://static.aod.icu/index/user/assets/vendor/libs/clipboard/clipboard.js"></script>
    ...
    function timer(){
        var timerId = window.setInterval(function(){
            ...
            if (hour <= 0 && minute <= 0 && second <= 0 && updateQrOk !== 1) {
                ...
                $("#qrcode").html('<img id="qrcode_load" src="https://static.aod.icu/index/images/status/qrcode_timeout.png">');//输出过期二维码提示图片
            } else if (updateQrOk === 1){
                $("#startApp").hide();
                $("#divTime").html("<small style='color:red; font-size:22px'>"+ result.msg +"</small>");
                $("#qrcode").html('<img id="qrcode_load" src="https://static.aod.icu/index/images/status/pay_ok.png">');//支付成功
            } else {
