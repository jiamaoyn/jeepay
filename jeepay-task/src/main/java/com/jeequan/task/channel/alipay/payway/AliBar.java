...
import com.jeequan.task.channel.alipay.AlipayKit;
...
import com.jeequan.task.rqrs.payorder.payway.AliBarOrderRQ;
import com.jeequan.task.rqrs.payorder.payway.AliBarOrderRS;
...
public class AliBar extends AlipayPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ rq, PayOrder payOrder, MchAppConfigContext mchAppConfigContext) {
        ...
        channelRetMsg.setChannelUserId(alipayResp.getBuyerOpenId()); //渠道用户标识
